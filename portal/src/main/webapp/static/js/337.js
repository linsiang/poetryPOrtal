(function () {
    ...
    function loadJs(url, onsuccess, loadDefault) {
        ...
        script.onerror = script.onload = script.onreadystatechange = function () {
            if (!done && (!this.readyState || this.readyState === "loaded" || this.readyState === "complete")) {
                ...
                var advjson = getWeightRandom(window['advjson337']);
    ...
    var _path = "http://www.zgshige.com/zcms/advertise/dataaction?pid=337&type=Weight&keywords=" + kw;
    // 专题编辑页面要避免使用缓存页面
    ...
    function onSuccess(advjson) {
        if (typeof window['advjson337'] != 'undefined') {
    ...
    if (kw == "") {
        advjson337 = [{
            "ID": 321,
            "PositionID": 337,
            "PositionCode": "syslgg4",
            "SiteID": 122,
            "ResourceID": 0,
            "AdName": "全国诗歌大赛",
            "AdType": "image",
            "AdContent": "{\"Images\":[{\"imgADLinkUrl\":\"http://www.zgshige.com/zwhd/\",\"imgADAlt\":\"诗歌地图\",\"ImgPath\":\"http://www.zgshige.com/upload/resources/image/2018/09/17/254004.jpg\"}],\"imgADLinkTarget\":\"New\",\"Count\":1,\"showAlt\":\"N\"}",
            "Weight": 0,
            "Keywords": "",
            "OrderFlag": 144783513017400,
            "IsHitCount": "N",
            "HitCount": 44813,
            "StickTime": 0,
            "IsOpen": "Y",
            "StartTime": "1457943858000",
            "EndTime": "4070939064000",
            "Memo": null,
            "LinkTarget": "New",
            "Prop1": null,
            "Prop2": null,
        ...
        onSuccess(getWeightRandom(advjson337));
    } else {
