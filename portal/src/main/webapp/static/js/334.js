(function () {
    ...
    function loadJs(url, onsuccess, loadDefault) {
        ...
        script.onerror = script.onload = script.onreadystatechange = function () {
            if (!done && (!this.readyState || this.readyState === "loaded" || this.readyState === "complete")) {
                ...
                var advjson = getWeightRandom(window['advjson334']);
    ...
    var _path = "http://www.zgshige.com/zcms/advertise/dataaction?pid=334&type=Weight&keywords=" + kw;
    // 专题编辑页面要避免使用缓存页面
    ...
    function onSuccess(advjson) {
        if (typeof window['advjson334'] != 'undefined') {
            ...
            var cmsAD = new ZCMSAD('cmsAD_334');
            cmsAD.PosID = 334;
    ...
    if (kw == "") {
        advjson334 = [{
            ...
            "SiteID": 122,
            "ResourceID": 0,
            "AdName": "\u201C每日好诗\u201D评选流程调整通知",
            "AdType": "image",
            "AdContent": "{\"Images\":[{\"imgADLinkUrl\":\"http://www.zgshige.com/c/2016-09-26/1846701.shtml\",\"imgADAlt\":\"\",\"ImgPath\":\"http://www.zgshige.com/upload/resources/image/2018/09/17/254001.jpg\"}],\"imgADLinkTarget\":\"New\",\"Count\":1,\"showAlt\":\"N\"}",
            "Weight": 0,
            "Keywords": "",
            "OrderFlag": 143926457406900,
            "IsHitCount": "N",
            "HitCount": 16161,
            "StickTime": 0,
            "IsOpen": "Y",
            "StartTime": "1439264574000",
        ...
        onSuccess(getWeightRandom(advjson334));
    } else {
