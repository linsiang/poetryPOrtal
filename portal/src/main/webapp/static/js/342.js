(function () {
    ...
    function loadJs(url, onsuccess, loadDefault) {
        ...
        script.onerror = script.onload = script.onreadystatechange = function () {
            if (!done && (!this.readyState || this.readyState === "loaded" || this.readyState === "complete")) {
                ...
                var advjson = getWeightRandom(window['advjson342']);
    ...
    var _path = "http://www.zgshige.com/zcms/advertise/dataaction?pid=342&type=Weight&keywords=" + kw;
    // 专题编辑页面要避免使用缓存页面
    ...
    function onSuccess(advjson) {
        if (typeof window['advjson342'] != 'undefined') {
            ...
            var cmsAD = new ZCMSAD('cmsAD_342');
            cmsAD.PosID = 342;
    ...
    if (kw == "") {
        ...
        onSuccess(getWeightRandom(advjson342));
    } else {
